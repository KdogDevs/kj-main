  ...
  return (
    <section id="socials" className="py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8" staggerDelay={0.1}>
          {socials.map((social, index) => (
            <StaggerItem key={social.name}>
              <motion.a
                ...
                className="group block rounded-2xl border border-border/50 p-6 bg-card/60 backdrop-blur-sm shadow-md h-full"
                whileHover={{ 
                  y: -8,
