...
const Hero = () => {
  ...
  const opacity = useTransform(scrollY, [0, 300], [1, shouldReduceMotion ? 0.8 : 0]);
  const scale = useTransform(scrollY, [0, 300], [1, shouldReduceMotion ? 0.98 : 0.9]);
  const y = useTransform(scrollY, [0, 300], [0, shouldReduceMotion ? 30 : 100]);
      ...
      >
        ...
        <div className="text-center lg:text-left flex-1">
          ...
          <motion.p 
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: isMobile ? 0.4 : 0.8, delay: isMobile ? 0.4 : 1 }}
          >
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: isMobile ? 0.5 : 1.2 }}
          >
            {isMobile ? (
              <button 
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-11 px-8 rounded-xl font-mono active:scale-95 transition-transform"
